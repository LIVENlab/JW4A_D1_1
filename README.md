...
model WindTrace, also created within the project. For more information on WindTrace, visit the GitHub repo: https://github.com/LIVENlab/WindTrace_public
...
- Life-cycle impact assessment of all wind parks using ReCiPe 2016 midpoint (H) impact methods (functional unit: one park. [not impacts/kWh]).

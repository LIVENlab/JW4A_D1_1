    ...
    for material in mass_materials.keys():
        ...
        if any(element in material for element in fe_alloys):
            ...
            # scenario == 3
                ...
                recycling_rate = 0.52
            inp = cutoff391.get(code=consts_wt.EOL_S1_EI391_ACTIVITY_CODES[material]['landfill']['code'])
            ...
            inp = cutoff391.get(code=consts_wt.EOL_S1_EI391_ACTIVITY_CODES[material]['incineration']['code'])
...
def lci_wind_turbine(park_name: str, park_power: float, number_of_turbines: int, park_location: str,
    ...
    consts_wt.PRINTED_WARNING_STEEL = False
